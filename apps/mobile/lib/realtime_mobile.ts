...
const WS_URL = 'wss://trailtag-production.up.railway.app/ws';
...
/**
 * Hook that maintains a live WebSocket connection to the backend and
 * calls `onEvent` whenever a realtime event arrives. Automatically
