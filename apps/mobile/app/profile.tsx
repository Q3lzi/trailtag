  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
        ...
        {/* ── FREUNDE TAB ── */}
        {tab === 'freunde' && (<>
          {/* My QR Code - real scannable QR */}
          <View style={[styles.card, {alignItems:'center', paddingVertical:24}]}>
            <Text style={styles.sectionLabel}>MEIN TRAILTAG-CODE</Text>
            {myQrCode ? (
              <View style={{padding:16,backgroundColor:'#fff',borderRadius:8,borderWidth:1,borderColor:'#e1e3e4',marginBottom:16}}>
                <QRCodeSVG
            ...
            <Text style={[styles.qrCode, {marginBottom:4}]}>{myQrCode?.slice(0,8).toUpperCase() ?? '...'}</Text>
            <Text style={[styles.qrSub, {textAlign:'center', marginBottom:16}]}>Freunde scannen diesen Code oder geben ihn manuell ein</Text>
